...
router.get(baseUrl, authMiddleware, // Ensures req.user.id exists
...
router.get(`${baseUrl}/with-players`, authMiddleware, associationMiddleware, async (req, res) => {
    try {
...
async function getTeamsWithPlayers(associationId) {
    // Fetch teams first
...
router.post(baseUrl, authMiddleware, // Ensures req.user.id exists
associationMiddleware, // Ensures req.association_id exists
async (req, res) => {
    try {
