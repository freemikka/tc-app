...
export function ShowJoinRequests() {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="outline h-9 rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring">
                Requests
            </DropdownMenuTrigger>
            <DropdownMenuContent>
                {joinRequests === null ? (
